...
- subnetOptimization (default False) -> True hides subnets That doesn't have a vnet Intergration (useful to avoid plotting all sunbets in the landing zone Vnet for example and only keep the ones linked to the used Private endpoints).
...
```
python3 src/main.py \
  --tenants aaaabbbb-... aaaabbbb-... \
  --subscriptions aaaabbbb-... aaaabbbb-... \
